...
public class EntitySymbolFiend extends EntityFlying implements ISymbol {
	...
	public void activate(EntityPlayer player) {
		...
		if (!player.getEntityWorld().isRemote && player.hasCapability(GoetiaProvider.goetiaCapability, null)){
			player.getCapability(GoetiaProvider.goetiaCapability, null).setImpurity(player,player.getCapability(GoetiaProvider.goetiaCapability, null).getImpurity()+rand.nextInt(4)+5);
		}
	}
