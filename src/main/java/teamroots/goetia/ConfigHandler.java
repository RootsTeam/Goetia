...
public class ConfigHandler
{
    ...
    {
        alignmentBarPosX = config.getInt("alignmentIconOffsetX", Configuration.CATEGORY_GENERAL, 0, -32767, 32767, "The alignment icon's x-offset");
        alignmentBarPosY = config.getInt("alignmentIconOffsetY", Configuration.CATEGORY_GENERAL, 0, -32767, 32767, "The alignment icon's y-offset");
